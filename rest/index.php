<?php
    ...
    Flight::route('POST /reset', function(){
      ...
      if(empty($error)) {
        ...
        $email->setFrom("inas@projekat.com", "Inas Ahmic");
        $email->setSubject('Password Renewal');
        $email->addTo($data['email']);
        $email->addContent("text/plain", 'Your password reset link: https://inasahmic.herokuapp.com/rest/verify/'.$username.'/'.$generatedNumber);
